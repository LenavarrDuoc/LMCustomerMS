    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI().info(new Info()
                ...
                .components(new Components()
                        ...
                        .addExamples("ClienteFindAllByPnombre200Example", new Example().value(leerJson("/examples/ClienteFindAllByPnombre200Example.html")))
                        .addExamples("ClienteFindAllByPnombre404Example", new Example().value(leerJson("/examples/ClienteFindAllByPnombre404Example.html")))
                        .addExamples("ClienteFindByEmail200Example", new Example().value(leerJson("/examples/ClienteFindByEmail200Example.json")))
                        .addExamples("ClienteFindByEmail404Example", new Example().value(leerJson("/examples/ClienteFindByEmail404Example.html")))
                        ...
                        .addExamples("ClienteFindByNumRun400Example", new Example().value(leerJson("/examples/ClienteFindByNumRun400Example.html")))
                        .addExamples("ClienteFindByNumRun404Example", new Example().value(leerJson("/examples/ClienteFindByNumRun404Example.html")))
                        .addExamples("ClienteSaveInputExample", new Example().value(leerJson("/examples/ClienteSaveInputExample.json")))
                        .addExamples("ClienteSave201Example", new Example().value(leerJson("/examples/ClienteSave201Example.json")))
                        .addExamples("ClienteSave400Example", new Example().value(leerJson("/examples/ClienteSave400Example.html")))
                        .addExamples("ClienteSave409Example", new Example().value(leerJson("/examples/ClienteSave409Example.html")))
                        .addExamples("ClienteUpdateInputExample", new Example().value(leerJson("/examples/ClienteUpdateInputExample.json")))
